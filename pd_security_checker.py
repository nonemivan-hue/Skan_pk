...
class SecurityCheckWorker(QThread):
    ...
    def _get_os_updates_instructions(self, system):
        """Инструкции по обновлению ОС - ПОДРОБНО ДЛЯ НАЧИНАЮЩИХ"""
        if system == 'Windows':
            return {
                'title': '📘 ПОШАГОВАЯ ИНСТРУКЦИЯ: Обновление операционной системы Windows',
                'steps': [
                    '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
                    ...
                    '   → Или нажмите клавишу Windows на клавиатуре (значок ⊞)',
                    '',
                    'ШАГ 2: Откройте Параметры Windows',
                    '   → Найдите значок "⚙️ Параметры" (шестеренка)',
                    '   → Кликните по нему левой кнопкой мыши',
                    '   → Альтернативно: нажмите клавиши Win + I на клавиатуре',
                    '',
                    'ШАГ 3: Перейдите в раздел обновлений',
                    '   → В открывшемся окне найдите и кликните "Обновление и безопасность"',
                    '   → (Значок выглядит как круговые стрелки обновления)',
                    '',
                    'ШАГ 4: Проверьте наличие обновлений',
                    '   → В левой части окна выберите "Центр обновления Windows"',
                    '   → Нажмите синюю кнопку "Проверить наличие обновлений"',
                    '   → Дождитесь завершения проверки (может занять 1-5 минут)',
                    '',
                    'ШАГ 5: Установите найденные обновления',
                    '   → Если обновления найдены, нажмите "Загрузить и установить"',
                    '   → Если видите кнопку "Установить сейчас" — нажмите её',
                    '   → Дождитесь загрузки и установки (может занять 10-60 минут)',
                    '',
                    'ШАГ 6: Перезагрузите компьютер',
                    '   → После установки появится кнопка "Перезагрузить сейчас"',
                    '   → Сохраните все открытые документы перед перезагрузкой!',
                    ...
                    '   → Нажмите правой кнопкой мыши на кнопке "Пуск"',
                    '   → Выберите "Windows PowerShell (администратор)"',
                    '   → Или "Терминал Windows (администратор)"',
                    '   → Подтвердите разрешение на внесение изменений',
                    '',
                    'ШАГ 2: Введите команды по очереди:',
                    '   → Сначала установите модуль обновлений:',
                    '     Install-Module -Name PSWindowsUpdate -Force',
                    '   → Если спросит подтверждение — введите Y и нажмите Enter',
                    '',
                    'ШАГ 3: Импортируйте модуль',
                    ...
                    '',
                    'ШАГ 5: Перезагрузите компьютер вручную',
                    '   → Закройте все программы',
                    '   → Пуск → Питание → Перезагрузка',
                    '',
                    '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
                    ...
                    '   → Нажмите Enter',
                    '',
                    'ШАГ 2: Запустите проверку обновлений',
                    '   → Введите команду:',
                    '     usoclient StartScan',
                    '   → Нажмите Enter',
                    '',
                    ...
                    '   → Нажмите Enter и дождитесь установки',
                    '',
                    '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
                    'КАК ПРОВЕРИТЬ, ЧТО ОБНОВЛЕНИЯ УСТАНОВЛЕНЫ',
                    '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
                    '',
                    'ВАРИАНТ 1: Через системную информацию',
                    '   → Нажмите Win + R',
                    '   → Введите: systeminfo',
                    '   → Нажмите Enter',
                    '   → Найдите строку "Hotfix(s):" — там будет количество обновлений',
                    '',
                    'ВАРИАНТ 2: Через журнал обновлений',
                    '   → Параметры → Обновление и безопасность',
                    '   → Нажмите "Журнал обновлений"',
                    '   → Вы увидите список установленных обновлений с датами'
                ],
                'verification': '✅ Убедитесь, что в журнале обновлений есть записи за сегодня, и система была перезапущена',
                'regulatory_basis': 'Приказ ФСТЭК №21, пункт 15: "Регулярное обновление программного обеспечения"'
            }
        else:  # Linux
            return {
                'title': '📘 ПОШАГОВАЯ ИНСТРУКЦИЯ: Обновление операционной системы Linux',
                'steps': [
                    '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
                    'ДЛЯ UBUNTU / DEBIAN И ДРУГИХ СИСТЕМ С APT',
                    '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
                    '',
                    ...
                    '     sudo apt update',
                    '   → Нажмите Enter',
                    '   → Введите ваш пароль (символы не будут отображаться)',
                    '   → Дождитесь завершения (30 секунд - 2 минуты)',
                    '',
                    'ШАГ 3: Установите обновления безопасности',
                    '   → Введите команду:',
                    '     sudo apt upgrade --only-upgrade security',
                    '   → Нажмите Enter',
                    '   → Когда спросят подтверждение — введите Y и нажмите Enter',
                    '   → Дождитесь завершения установки',
                    '',
                    'ШАГ 4: Установите все остальные обновления (опционально)',
                    '   → Введите команду:',
                    '     sudo apt full-upgrade',
                    '   → Нажмите Enter и подтвердите (Y)',
                    '',
                    'ШАГ 5: Для автоматического обновления в будущем',
                    '   → Введите команду:',
                    '     sudo apt install unattended-upgrades',
                    '   → Подтвердите установку (Y)',
                    '',
                    'ШАГ 6: Настройте автоматические обновления',
                    '   → Введите команду:',
                    '     sudo dpkg-reconfigure unattended-upgrades',
                    '   → Выберите "Yes" стрелками и нажмите Enter',
                    '',
                    'ШАГ 7: Перезагрузите систему (если требуется)',
                    '   → Введите команду:',
                    '     sudo systemctl reboot',
                    '   → Или через меню: выключение → перезагрузка',
                    '',
                    '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
                    'ДЛЯ CENTOS / RHEL / FEDORA (С YUM/DNF)',
                    '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
                    '',
                    'ШАГ 1: Откройте терминал',
                    '   → Нажмите Ctrl + Alt + T',
                    '',
                    'ШАГ 2: Обновите пакеты безопасности',
                    '   → Для CentOS/RHEL:',
                    '     sudo yum update --security',
                    '   → Для Fedora:',
                    '     sudo dnf update --security',
                    '   → Подтвердите обновление (Y)',
                    '',
                    ...
                    '→ Введите команду:',
                    '  apt list --upgradable',
                    '→ Если ничего не показано — все пакеты обновлены',
                    '→ Если есть список — выполните обновление еще раз'
                ],
                'verification': '✅ Команда "apt list --upgradable" не показывает никаких пакетов',
                'regulatory_basis': 'Приказ ФСТЭК №21, пункт 15: "Регулярное обновление программного обеспечения"'
            }

    def _get_antivirus_instructions(self, system):
        """Инструкции по настройке антивирусной защиты - ПОДРОБНО ДЛЯ НАЧИНАЮЩИХ"""
        if system == 'Windows':
            return {
                'title': '📘 ПОШАГОВАЯ ИНСТРУКЦИЯ: Настройка антивирусной защиты Windows',
                'steps': [
                    '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
                    'ВАРИАНТ 1: Использование Kaspersky Endpoint Security (РЕКОМЕНДУЕТСЯ)',
                    '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
                    '',
                    'ШАГ 1: Скачайте установщик',
                    '   → Откройте браузер',
                    '   → Перейдите на сайт: https://www.kaspersky.ru/endpoint-security',
                    '   → Нажмите "Скачать пробную версию"',
                    '   → Сохраните файл на рабочий стол',
                    '',
                    'ШАГ 2: Установите программу',
                    '   → Найдите скачанный файл на рабочем столе',
                    ...
                    '   → Дождитесь завершения установки',
                    '',
                    'ШАГ 3: Активируйте продукт',
                    '   → Запустите Kaspersky из системного трея (возле часов)',
                    '   → Нажмите "Активировать"',
                    '   → Введите лицензионный ключ (если есть)',
                    '   → Или выберите "Активировать пробную версию"',
                    '',
                    'ШАГ 4: Проверьте состояние защиты',
                    '   → Откройте главное окно Kaspersky',
                    '   → Убедитесь, что все компоненты зеленые',
                    '   → Если видите желтые или красные значки — нажмите на них',
                    '   → Следуйте рекомендациям для включения защиты',
                    '',
                    'ШАГ 5: Обновите антивирусные базы',
                    '   → В главном окне нажмите "Обновление"',
                    '   → Нажмите кнопку "Обновить"',
                    '   → Дождитесь завершения обновления баз',
                    '',
                    'ШАГ 6: Запустите полную проверку',
                    '   → Нажмите "Проверка"',
                    '   → Выберите "Полная проверка"',
                    '   → Нажмите "Запустить проверку"',
                    '   → Дождитесь завершения (может занять 30-60 минут)',
                    '',
                    '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
                    ...
                    'ШАГ 1: Скачайте установщик',
                    '   → Откройте браузер',
                    '   → Перейдите на сайт: https://www.drweb.ru/',
                    '   → Нажмите "Скачать"',
                    '   → Выберите "Dr.Web Security Space"',
                    '   → Сохраните файл',
                    '',
                    'ШАГ 2: Установите программу',
                    ...
                    '',
                    'ШАГ 3: Активируйте и обновите',
                    '   → Запустите Dr.Web',
                    '   → Нажмите "Обновить базы"',
                    '   → Дождитесь завершения',
                    '',
                    '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
                    'ВАРИАНТ 3: Использование встроенного Защитника Windows',
                    '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
                    '',
                    ...
                    '   → Нажмите Enter',
                    '',
                    'ШАГ 2: Проверьте состояние защиты',
                    '   → Нажмите "Защита от вирусов и угроз"',
                    '   → Убедитесь, что защита включена (зеленая галочка)',
                    '',
                    'ШАГ 3: Включите защиту (если отключена)',
                    '   → Нажмите "Управление настройками"',
                    '   → Включите переключатель "Защита в режиме реального времени"',
                    '   → Включите "Облачная защита"',
                    '',
                    'ШАГ 4: Обновите сигнатуры вирусов',
                    '   → В разделе "Защита от вирусов и угроз"',
                    '   → Нажмите "Проверка наличия обновлений"',
                    '   → Дождитесь завершения',
                    '',
                    'ШАГ 5: Запустите полную проверку',
                    '   → Нажмите "Параметры сканирования"',
                    '   → Выберите "Полное сканирование"',
                    '   → Нажмите "Выполнить сканирование сейчас"',
                    '   → Дождитесь завершения'
                ],
                'verification': '✅ Запустите полную проверку системы и убедитесь, что дата обновления баз — сегодня',
                'regulatory_basis': 'Приказ ФСТЭК №21, пункт 16: "Использование антивирусных средств защиты"'
            }
        else:  # Linux
            return {
                'title': '📘 ПОШАГОВАЯ ИНСТРУКЦИЯ: Настройка антивирусной защиты Linux',
                'steps': [
                    '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
                    'ВАРИАНТ 1: Kaspersky Endpoint Security для Linux (РЕКОМЕНДУЕТСЯ)',
                    '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
                    '',
                    'ШАГ 1: Скачайте установщик',
                    '   → Откройте браузер',
                    '   → Перейдите на сайт Kaspersky для бизнеса',
                    '   → Найдите "Kaspersky Endpoint Security для Linux"',
                    '   → Скачайте файл kesl_installer.run',
                    '   → Сохраните в папку Загрузки',
                    '',
                    'ШАГ 2: Откройте терминал',
                    '   → Нажмите Ctrl + Alt + T',
                    '',
                    'ШАГ 3: Перейдите в папку загрузок',
                    '   → Введите команду:',
                    '     cd ~/Загрузки',
                    '   → Или:',
                    '     cd ~/Downloads',
                    ...
                    '   → Дождитесь завершения',
                    '',
                    'ШАГ 6: Активируйте продукт',
                    '   → Введите команду:',
                    '     sudo /opt/kaspersky/kesl/bin/kesl-control --set-license <ваш_ключ>',
                    '   → Замените <ваш_ключ> на реальный лицензионный ключ',
                    '',
                    ...
                    '',
                    '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
                    'ВАРИАНТ 3: ClamAV (бесплатное решение)',
                    '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
                    '',
                    ...
                    '',
                    'ШАГ 2: Остановите службу для обновления',
                    '   → Введите команду:',
                    '     sudo systemctl stop clamav-freshclam',
                    '',
                    'ШАГ 3: Обновите базы вручную',
                    '   → Введите команду:',
                    '     sudo freshclam',
                    '   → Дождитесь завершения',
                    '',
                    'ШАГ 4: Запустите службу обратно',
                    '   → Введите команду:',
                    '     sudo systemctl start clamav-freshclam',
                    '',
                    'ШАГ 5: Просканируйте систему',
                    '   → Введите команду:',
                    '     clamscan -r /home',
                    '   → Для удаления угроз:',
                    '     clamscan -r --remove /home'
                ],
                'verification': '✅ Выполните полное сканирование системы и проверьте, что дата обновления баз — сегодня',
                'regulatory_basis': 'Приказ ФСТЭК №21, пункт 16: "Использование антивирусных средств защиты"'
            }
